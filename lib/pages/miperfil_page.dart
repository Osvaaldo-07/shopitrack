...
class MiperfilPage extends StatefulWidget {
  ...
  MiperfilPage({Key? key, required this.nombre, required this.token, required this.imagen, required this.mainMenuController}) : super(key: key);

  @override
  _MiperfilPageState createState() => _MiperfilPageState();
}

class _MiperfilPageState extends State<MiperfilPage> with AfterLayoutMixin {
