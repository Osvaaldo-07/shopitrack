...
class NotificacionesEntregaPage extends StatefulWidget {
  static const routeName = "notificacionesentrega";
  final String nombre;
  final String token;
  final String imagen;
  ...
  NotificacionesEntregaPage({Key? key, required this.token, required this.imagen, required this.imageUrl, required this.nombre, required this.idorden, required this.orden, required this.direccion, required this.visto, required this.estructura, required this.idnotif}) : super(key: key);

  @override
  _NotificacionesEntregaPageState createState() => _NotificacionesEntregaPageState();
}

class _NotificacionesEntregaPageState extends State<NotificacionesEntregaPage> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: responsive.dp(1)),
                Text(
                  'Tu orden ${widget.orden} ha sido realizada',
